    ...
    internal class TokenValidateHandler : DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    ValidAudience = System.Configuration.ConfigurationManager.AppSettings["Audience"].ToString(),
                    ValidIssuer = System.Configuration.ConfigurationManager.AppSettings["Issuer"].ToString(),
